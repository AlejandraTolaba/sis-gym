                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <p class="h6"><strong>Fecha de nacimiento: </strong>{{ $student->birthdate }}</p>
                                    ...
                                    <p class="h6"><strong>Fecha de presentación de certificado: </strong>{{ $student->certificate_date ? $student->certificate_date : 'No presentado' }}</p>
